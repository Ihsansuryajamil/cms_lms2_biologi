        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4">
                ...
                <div class="col course-item-wrapper">
                    <div class="course-card" onclick="window.location.href='{{ route('detail_course') }}';" style="cursor: pointer;">
                    ...
                    <div class="course-popover">
                        ...
                        <a href="{{ route('detail_course') }}" class="btn btn-preview-course text-center text-decoration-none d-block">LIHAT PREVIEW MATERI</a>
